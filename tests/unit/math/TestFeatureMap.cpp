...
template <typename T>
class TestFeatureMap : public testing::Test {
 protected:
...
TYPED_TEST_SUITE(TestFeatureMap, TestTypes);

TYPED_TEST(TestFeatureMap, TruncatedFourierFeatureMapConstructor) {
...
TYPED_TEST(TestFeatureMap, TruncatedFourierFeatureMapApply) {
...
TYPED_TEST(TestFeatureMap, TruncatedFourierFeatureMapApplyMatrix) {
...
TYPED_TEST(TestFeatureMap, TruncatedFourierFeatureMapApplyVector) {
  const Vector x{Vector::Random(this->x_limits_.dimension())};
