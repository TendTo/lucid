...
\newcommand{\Bmax}{\hat{\B}} % Maximum value of barrier
\newcommand{\Bmin}{\check{\B}} % Minimum value of barrier
...
\newcommand{\barrII}{\texttt{Barr\textsubscript{2}}\xspace}
\newcommand{\barrIII}{\texttt{Barr\textsubscript{3}}\xspace}
\newcommand{\overtaking}{\texttt{Over}\xspace}
...
morestring=[b]',
literate=
*{0}{{{\color{keywordBlue}0}}}{1}
{1}{{{\color{keywordBlue}1}}}{1}
{2}{{{\color{keywordBlue}2}}}{1}
{3}{{{\color{keywordBlue}3}}}{1}
{4}{{{\color{keywordBlue}4}}}{1}
{5}{{{\color{keywordBlue}5}}}{1}
{6}{{{\color{keywordBlue}6}}}{1}
{7}{{{\color{keywordBlue}7}}}{1}
{8}{{{\color{keywordBlue}8}}}{1}
{9}{{{\color{keywordBlue}9}}}{1}
}
...
\lstdefinestyle{spacednonumbers}{numbers=none,numberstyle=\footnotesize,xleftmargin=0em,aboveskip=15pt,belowskip=15pt,backgroundcolor=\color{white}}
\lstdefinestyle{bgnonumbers}{numbers=none,numberstyle=\footnotesize,xleftmargin=0em,backgroundcolor=\color{white},backgroundcolor=\color{ipython_bg},}
%
