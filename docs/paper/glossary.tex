...
\newglossaryentry{lp}{
    first={Linear Program (LP)},
    name={Linear Program},
    text={LP},
    description={
            A Linear Program is an optimization problem where the objective function and the constraints
...
\newglossaryentry{rkhs}{
    name={Reproducing Kernel Hilbert Space},
    text={RKHS},
    first={Reproducing Kernel Hilbert Space (RKHS)},
    firstplural={Reproducing Kernel Hilbert Spaces (RKHS)},
    description={}
}
\newglossaryentry{cbc}{
    name={Control Barrier Certificate},
    text={CBC},
    plural={CBCs},
    first={\emph{Control Barrier Certificate} (CBC)},
    firstplural={\emph{Control Barrier Certificates} (CBCs)},
    description={}
}
\newglossaryentry{cbf}{
    name={Control Barrier Certificate},
    text={CBF},
    plural={CBFs},
    first={\emph{Control Barrier Function} (CBF)},
    firstplural={\emph{Control Barrier Functions} (CBFs)},
    description={}
}
\newglossaryentry{gui}{
...
\newglossaryentry{cli}{
    ...
    text={CLI},
    first={\emph{Command Line Interface} (CLI)},
    description={}
}
\newglossaryentry{nn}{
    name={Neural Network},
...
\newglossaryentry{cme}{
    name={Conditional Mean Embedding},
    text={CME},
    plural={CMEs},
    first={\emph{Conditional Mean Embedding} (CME)},
    firstplural={\emph{Conditional Mean Embeddings} (CMEs)},
    description={}
}
\newglossaryentry{rl}{
...
\newglossaryentry{mdp}{
    ...
    firstplural={Markov Decision Process (MDPs)},
    description={}
}