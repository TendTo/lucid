...
{\color{red}Further information about \pylucid are deferred to the appendix.}
...
The results of all experimental results are summarized in Table~\ref{tbl:benchmarks_results}.
\begin{table}[tb]
    \centering
    \begin{tabular}{ccccc}
        \toprule
        \textbf{Benchmark} & \textbf{Dim} & \textbf{Lattice} & \textbf{Runtime} & \textbf{Safety} \\
                           &              & \textbf{Size} & [mm:ss]          & \textbf{Probability}                  \\ % Units
        \midrule
        Linear             & 1            & $?$              & 00:02            & 95.15\%                 \\
        Barr2              & 2            & $350^2$           & 14:42            & 75.34\%                    \\
