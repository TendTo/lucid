\begin{figure}
    ...
    \begin{tikzpicture}[node distance=0.6cm and 0.6cm,
        ...
        \node[block, below=of estimator, text width=2.4cm] (feature) {\Circled{4} Feature Map}; % / Barrier template
        \node[block, left=.4cm of feature] (optimizer) {\Circled{5} Solver};
        ...
        fit=(estimator)(feature)(optimizer)(sets)(tuner), label={[xshift=3cm]below:{\textbf{\lucid}}}] {};
        ...
        \node[output-block, right=.5cm of output] (prob) {Safety Probability};
