\begin{figure}[ht]
    ...
    \begin{tikzpicture}[node distance=0.4cm and 0.9cm,
            input-block/.style={rectangle, draw, fill=white, text width=2.9cm, minimum height=1.0cm, align=center, rounded corners, drop shadow=gray!50},
            output-block/.style={rectangle, draw, fill=green!20, text width=2.9cm, minimum height=1.0cm, align=center, rounded corners, drop shadow=gray!50},
