 ...
 * @return closeness score between the two sets of row vectors
 */
 ...
 * The MSE score is always non-positive, and a higher value indicates a better fit.
 ...
 * @param x @nxd matrix of row vectors
 * @param y @nxd matrix of row vectors
 * @return mean squared error between the two sets of row vectors
 */
 ...
 * @f]
 * where @f$ n @f$ is the number of rows in the evaluation data.
 * The RMSE score is always non-positive, and a higher value indicates a better fit.
 ...
 * @f]
 * where @f$ n @f$ is the number of rows in the evaluation data.
 * The RMSE score is always non-positive, and a higher value indicates less distance.
 * @warning The RMSE score is non-positive by definition in this implementation.
 * @pre The number of rows in `x` must be equal to the number of rows in `y`.
 * @param x @nxdx evaluation input data
 * @param y @nxdy evaluation output data
 * @return root mean squared error score of the model
 */
