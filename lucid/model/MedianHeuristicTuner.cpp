...
std::string MedianHeuristicTuner::to_string() const { return "MedianHeuristicTuner( )"; }

std::ostream& operator<<(std::ostream& os, const MedianHeuristicTuner& tuner) { return os << tuner.to_string(); }
