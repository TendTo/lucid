 ...
 * @file
 */
#include "lucid/benchmark/InitBarr3Generator.h"

#include "lucid/util/error.h"

namespace lucid::benchmark {
Matrix InitBarr3Generator::operator()(ConstMatrixRef x) const { return f_stoch(x); }

Matrix InitBarr3Generator::f_stoch(ConstMatrixRef x) {
...
Matrix InitBarr3Generator::f_det(ConstMatrixRef x) {
  if (x.size() != 2) LUCID_INVALID_ARGUMENT_EXPECTED("x.size()", x.size(), 2);
