...
class Configuration(Namespace):
    ...
    Attributes:
        ...
        x_samples: Input samples for the state variable x. If not provided, it will be generated from the X_bounds.
        xp_samples: Input samples for the next state variable x+. If not provided, it will be generated by applying the system dynamics to the x_samples.
        f_xp_samples: Precomputed samples of the next state variable x+ or a function that computes them. If not provided, it will be generated by applying the appropriate feature map.
...
def arg_parser() -> "ArgumentParser":
    ...
    parser.add_argument(
        "-i",
        "--x-samples",
        help="input samples for the state variable x. If not provided, it will be generated from the X_bounds. "
    ...
    parser.add_argument(
        "-o",
        "--xp-samples",
        help="input samples for the next state variable x+. If not provided, it will be generated by applying the system dynamics to the x_samples. "
        "Can be a json-like 2D array or path to a .npy, .npz or .csv file",
        action=NMatrixAction,
        type=str,
    )
