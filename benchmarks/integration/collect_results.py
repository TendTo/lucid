    ...
    data = pd.DataFrame(
        {
            ...
            "max_sx0": float(run.data.metrics.get("max_sx0", -1)),
            "max_xu": float(run.data.metrics.get("max_xu", -1)),
            "min_sxu": float(run.data.metrics.get("min_sxu", -1)),
            "max_x": float(run.data.metrics.get("max_x", -1)),
            "min_sx": float(run.data.metrics.get("min_sx", -1)),
            "min_d": float(run.data.metrics.get("min_d", -1)),
            "max_d_sx": float(run.data.metrics.get("max_d_sx", -1)),
